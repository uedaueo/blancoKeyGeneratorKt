...
/**
 * キージェネレータのフィールドをあらわすバリューオブジェクトクラス。このクラスの設定情報をもとにフィールドとセッター・ゲッターが自動生成されます。
 */
public class BlancoKeyGeneratorKtFieldStructure {
    /**
     * 項目番号。省略可能です。
     *
     * フィールド: [no]。
    ...
    public String toString() {
        ...
        buf.append("blanco.keygeneratorkt.valueobject.BlancoKeyGeneratorKtFieldStructure[");
        buf.append("no=" + fNo);
     ...
     */
    public void copyTo(final BlancoKeyGeneratorKtFieldStructure target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoKeyGeneratorKtFieldStructure#copyTo(target): argument 'target' is null");
        }
