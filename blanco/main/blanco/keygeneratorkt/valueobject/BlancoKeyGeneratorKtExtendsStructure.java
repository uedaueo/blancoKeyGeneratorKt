...
/**
 * キージェネレータの継承をあらわすバリューオブジェクトクラス。このクラスの設定情報をもとに継承が自動生成されます。
 */
public class BlancoKeyGeneratorKtExtendsStructure {
    /**
     * 項目番号。省略可能です。
     *
     * フィールド: [no]。
    ...
    public String toString() {
        ...
        buf.append("blanco.keygeneratorkt.valueobject.BlancoKeyGeneratorKtExtendsStructure[");
        buf.append("no=" + fNo);
     ...
     */
    public void copyTo(final BlancoKeyGeneratorKtExtendsStructure target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoKeyGeneratorKtExtendsStructure#copyTo(target): argument 'target' is null");
        }
