...
/**
 * キージェネレータの委譲をあらわすバリューオブジェクトクラス。このクラスの設定情報をもとにフィールドとセッター・ゲッターが自動生成されます。
 */
public class BlancoKeyGeneratorKtDelegateStructure {
    /**
     * 項目番号。省略可能です。
     *
     * フィールド: [no]。
    ...
    public String toString() {
        ...
        buf.append("blanco.keygeneratorkt.valueobject.BlancoKeyGeneratorKtDelegateStructure[");
        buf.append("no=" + fNo);
     ...
     */
    public void copyTo(final BlancoKeyGeneratorKtDelegateStructure target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoKeyGeneratorKtDelegateStructure#copyTo(target): argument 'target' is null");
        }
