...
public class BlancoKeyGeneratorKtMessage {
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI01]の文字列を取得します。
     *
     * No.2:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI02]の文字列を取得します。
     *
     * No.3:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI03]の文字列を取得します。
     *
     * No.4:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI04]の文字列を取得します。
     *
     * No.5:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI05]の文字列を取得します。
     *
     * No.6:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI06]の文字列を取得します。
     *
     * No.7:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI07]の文字列を取得します。
     *
     * No.8:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI08]の文字列を取得します。
     *
     * No.9:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJI09]の文字列を取得します。
     *
     * No.10:
    ...
    /**
     * メッセージ定義ID[BlancoKeyGeneratorKt]、キー[MBVOJA01]の文字列を取得します。
     *
     * No.11:
