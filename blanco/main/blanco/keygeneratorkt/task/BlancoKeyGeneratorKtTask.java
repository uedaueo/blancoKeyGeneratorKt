 ...
 * Antタスクへの組み込み例<br>
 * <pre>
 * &lt;taskdef name=&quot;blancokeygeneratorkt&quot; classname=&quot;blanco.keygeneratorkt.task.BlancoKeyGeneratorKtTask">
 *     &lt;classpath&gt;
...
public class BlancoKeyGeneratorKtTask extends Task {
    ...
    public final void execute() throws BuildException {
        System.out.println("BlancoKeyGeneratorKtTask begin.");
        ...
        try {
            ...
            final BlancoKeyGeneratorKtProcess proc = new BlancoKeyGeneratorKtProcessImpl();
            if (proc.execute(fInput) != BlancoKeyGeneratorKtBatchProcess.END_SUCCESS) {
