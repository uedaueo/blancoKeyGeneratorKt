...
/**
 * Process [BlancoKeyGeneratorKtProcess] interface.
 *
 * Inherit this interface and create a [BlancoKeyGeneratorKtProcessclass in the [blanco.keygeneratorkt.task] package to implement the actual batch processing.<br>
 */
interface BlancoKeyGeneratorKtProcess {
    /**
     ...
     */
    int execute(final BlancoKeyGeneratorKtProcessInput input) throws IOException, IllegalArgumentException;
