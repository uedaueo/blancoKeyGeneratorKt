package blanco.keygeneratorkt.task.valueobject;

/**
 * An input value object class for the processing class [BlancoKeyGeneratorKtProcess].
 */
public class BlancoKeyGeneratorKtProcessInput {
    /**
    ...
    public String toString() {
        ...
        buf.append("blanco.keygeneratorkt.task.valueobject.BlancoKeyGeneratorKtProcessInput[");
     ...
     */
    public void copyTo(final BlancoKeyGeneratorKtProcessInput target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoKeyGeneratorKtProcessInput#copyTo(target): argument 'target' is null");
        }
