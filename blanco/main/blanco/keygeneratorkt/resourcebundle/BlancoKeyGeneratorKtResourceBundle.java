package blanco.keygeneratorkt.resourcebundle;
...
/**
 * blancoKeyGeneratorKtが利用するリソースバンドルを蓄えます。
 *
 * リソースバンドル定義: [BlancoKeyGeneratorKt]。<BR>
 ...
 * </UL>
 */
public class BlancoKeyGeneratorKtResourceBundle {
    /**
     * リソースバンドルオブジェクト。
     *
    ...
    /**
     * BlancoKeyGeneratorKtResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoKeyGeneratorKt]、デフォルトのロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     */
    public BlancoKeyGeneratorKtResourceBundle() {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/keygeneratorkt/resourcebundle/BlancoKeyGeneratorKt");
     ...
     * BlancoKeyGeneratorKtResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoKeyGeneratorKt]、指定されたロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     */
    public BlancoKeyGeneratorKtResourceBundle(final Locale locale) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/keygeneratorkt/resourcebundle/BlancoKeyGeneratorKt", locale);
        } catch (MissingResourceException ex) {
        }
    }
     ...
     * BlancoKeyGeneratorKtResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoKeyGeneratorKt]、指定されたロケール、指定されたクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     * @param loader クラスローダの指定
     */
    public BlancoKeyGeneratorKtResourceBundle(final Locale locale, final ClassLoader loader) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/keygeneratorkt/resourcebundle/BlancoKeyGeneratorKt", locale, loader);
        } catch (MissingResourceException ex) {
        }
    }
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[METAFILE_DISPLAYNAME]
     *
     * [バリューオブジェクト定義書] (ja)<br>
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.FIELD.NAME]
     *
     * [フィールド: [{0}]。] (ja)<br>
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.FIELD.DEFAULT]
     *
     * [デフォルト: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.SET.JAVADOC.01]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.SET.JAVADOC.02]
     *
     * [フィールドの説明: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.SET.ARG.JAVADOC]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.GET.JAVADOC.01]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.GET.JAVADOC.02]
     *
     * [フィールドの説明: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.GET.DEFAULT.JAVADOC]
     *
     * [デフォルト: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2JAVACLASS.GET.RETURN.JAVADOC]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.ERR001]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.ERR002]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.ERR003]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.ERR004]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.ERR005]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.ERR006]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.ERR007]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.FIELD.NAME]
     *
     * [フィールド [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.FIELD.TYPE]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.FIELD.DEFAULT]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.SET.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.SET.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.SET.ARG.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.GET.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.GET.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.GET.ARG.LANGDOC]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.GET.RETURN.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.TYPE.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.TYPE.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.TYPE.ARG.LANGDOC]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[XML2SOURCE_FILE.TYPE.RETURN.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[ANTTASK.ERR001]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[META2XML.ELEMENT_COMMON_CS]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[META2XML.ELEMENT_COMMON_JS]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[META2XML.ELEMENT_COMMON_VB]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[META2XML.ELEMENT_COMMON_PHP]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[META2XML.ELEMENT_COMMON_RUBY]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[META2XML.ELEMENT_COMMON_PYTHON]
     *
    ...
    /**
     * bundle[BlancoKeyGeneratorKt], key[META2XML.ELEMENT_COMMON_KT]
     *
