 ...
 *
 * This is one of the main classes of blancoKeyGeneratorKt.
 *
 * @author IGA Tosiki
 * @author tueda
 */
public class BlancoKeyGeneratorKtXml2KotlinClass {
    /**
     * A message.
     */
    ...
    /**
     * Resource bundle object for blancoKeyGenerator.
     */
...
//        BlancoBeanUtils.generateCopyToMethod(fCgSourceFile, fCgClass);
    ...
    private void buildField(
        ...
        /*
         * In blancoKeyGenerator, the property name is prefixed with "f", but in Kotlin, it is not prefixed because of the implicit getter/setter.
         */
...
//        }
        ...
        /*
         * For the time being, private and getter/setter are not supported in blancoKeyGeneratorKt.
         */
        ...
        if (argFieldStructure.getDefault() != null || argFieldStructure.getDefaultKt() != null) {
             ...
             * Nevertheless, blancoKeyGeneratorKt will not support abstract properties for the time being.
             */
            ...
            if (argClassStructure.getAdjustDefaultValue() == false) {
                ...
                if (type.equals("kotlin.String")) {
                    ...
                    // TODO: In the case of second generation blancoKeyGenerator adoption, all class imports are appropriate.
...
//            System.out.println("/* tueda */ method annotation = " + field.getAnnotationList().get(0));
    ...
    private void buildMethodToString(
        ...
        /*
         * For the time being, toString override is not allowed in blancoKeyGeneratorKt.
        ...
        for (int indexField = 0; indexField < argClassStructure.getFieldList()
                .size(); indexField++) {
            final BlancoKeyGeneratorKtFieldStructure field = (BlancoKeyGeneratorKtFieldStructure) argClassStructure
                    .getFieldList().get(indexField);
